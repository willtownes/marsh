...
po2<-melt(po,c("Date","plot","soilWC","temp"),c("rbnh","ponh"),"saltype",value.name="salcount")
...
bl2<-melt(bl,c("Date","plot","soilWC","temp"),c("rbnh","blnh"),"saltype",value.name="salcount")
